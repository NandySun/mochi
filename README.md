...
![Version](https://img.shields.io/badge/version-0.2.0-c47e3a)
...
| 版本 | 文件名 | 说明 |
|---|---|---|
| 安装版 | `Mochi_0.2.0_x64-setup.exe` | NSIS 安装器，数据存 `%APPDATA%/mochi/` |
| 便携版 | `mochi-v0.2.0-portable.zip` | 解压即用，数据存 exe 同级目录 |
